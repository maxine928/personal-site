  ...
  return (
    <div className="min-h-screen bg-cream text-charcoal">
      ...
      <section className="py-20 max-w-2xl mx-auto px-6 text-center">
        ...
        <p className="font-body text-lg text-mid-gray leading-relaxed max-w-2xl mx-auto">
      ...
      {/* Old writings */}
      <div className="max-w-2xl mx-auto px-6 py-10 border-t border-royal-blue/10 mt-10">
        <a
